...
import { A as Avatar } from './Avatar-DF79Ko41.js';
 ...
 * ```
 */
const Header = ({ children, onClick, breadcrumb, skeleton, }) => (jsxs("header", { className: "header-root", children: [jsxs("div", { children: [jsx("div", { className: "header-action", children: jsx(ButtonIcon, { variant: "primary", appearance: "plain", size: "md", icon: "menu", onClick: onClick, skeleton: skeleton }) }), jsx("div", { className: "header-breadcrumb", children: breadcrumb })] }), children] }));
...
const HeaderProfile = ({ name, children, avatar_src, letter, skeleton, }) => {
    ...
    const dropdown = React.isValidElement(children)
        ...
        : children;
    return (jsxs("div", { ref: dropdownRef, className: "profile-root", children: [jsxs("button", { className: "profile", tabIndex: 0, onClick: toggle, disabled: skeleton, children: [jsx("div", { className: "avatar", children: jsx(Avatar, { skeleton: skeleton, size: "md", src: avatar_src, letter: letter }) }), skeleton ? (jsx(Skeleton, { height: "24px", width: "70px" })) : (jsx("h1", { className: "name", children: name })), jsx("div", { className: `icon ${state}`, children: jsx(Icon, { size: "sm", icon: "keyboard_arrow_down" }) })] }), dropdown] }));
};
