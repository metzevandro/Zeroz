...
function TableHeader({ columns }) {
    return (jsx("div", { className: "table-container", children: columns.map((column, index) => (jsx("div", { className: "th", children: column }, index))) }));
}
...
function TableBody({ columns, size }) {
    return (jsx("div", { className: "table-container", children: columns.map((column, colIndex) => (jsx("div", { className: "table-column", children: column.map((cell, cellIndex) => (jsx("div", { className: `td ${size} border`, children: cell }, cellIndex))) }, colIndex))) }));
}
...
const TableList = ({ columns, data, size }) => {
    ...
    return (jsx("div", { className: `table-list-root ${isOverflowed ? "overflow-ativo" : ""}`, ref: containerRef, children: jsxs("div", { className: "table", children: [jsx(TableHeader, { columns: columns }), jsx(TableBody, { columns: transposedData, size: size })] }) }));
};
