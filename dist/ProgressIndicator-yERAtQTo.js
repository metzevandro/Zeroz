...
const ProgressIndicator = ({ step, description, state, direction, onClick, widthFull = false, }) => {
    ...
    return (jsxs("div", { className: `progress-indicator ${direction} ${state}`, onClick: onClick, style: getWidthStyle(widthFull), children: [jsxs("div", { className: `header ${state}`, children: [jsx("div", { children: jsx(Icon, { icon: icon, size: "sm", fill: !["circle", "block", "error"].includes(icon) }) }), jsx("h1", { children: step })] }), description && jsx("p", { children: description })] }));
};
