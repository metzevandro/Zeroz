export type NotificationVariant = "primary" | "secondary" | "warning" | "success";
...
export interface NotificationEntry extends Omit<NotificationProps, "type" | "isOpen" | "isExiting"> {
