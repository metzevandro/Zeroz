...
var Button = function (_a) {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null, skeleton && dimensions ? (react_1.default.createElement(Skeleton_1.default, { height: "".concat(dimensions.height), width: "".concat(dimensions.width) })) : (label && (react_1.default.createElement("button", __assign({}, rest, { ref: buttonRef, className: buttonClass, disabled: disabled }),
        variant === "is-loading" && react_1.default.createElement(Loading_1.default, { variant: "default" }),
        typeIcon && react_1.default.createElement(Icon_1.default, { icon: typeIcon, size: "sm" }),
        label)))));
};
