...
const Switch = ({ modelValue, value, label, id, name, required = false, noEvents = false, disabled = false, onUpdate, }) => {
    ...
    return (jsxs("label", { className: getSwitchClassList(disabled, noEvents), htmlFor: uid, children: [jsx("input", { type: "checkbox", id: uid, value: value, name: name, required: required, disabled: disabled, checked: checked, onChange: handleChange, onKeyDown: handleKeyDown }), jsx("span", { className: "ui-form-checkbox-checkmark" }), label && jsx("div", { className: "ui-form-checkbox-text", children: label })] }));
};
