...
function DatePicker({ value, onChange, label, disabled = false, skeleton = false, }) {
    ...
    return (jsxRuntime.jsxs("div", { style: { display: "flex", flexDirection: "column" }, children: [jsxRuntime.jsx(Input.Input, { label: label, onClick: () => setIsCalendarOpen((prev) => !prev), error: error, textError: errorMessage, value: inputValue, onChange: handleInputChange, onKeyDown: handleKeyDown, icon: "calendar_month", fillIcon: true, disabled: disabled, skeleton: skeleton }), !isMobileScreen && (jsxRuntime.jsx("div", { className: `data-picker ${isCalendarOpen ? "open" : ""}`, children: jsxRuntime.jsx(DatePickerCalendar, { selectedDate: selectedDate, onSelectDate: handleSelectDate, onClose: () => setIsCalendarOpen(false), onRevert: handleRevert }) })), isMobileScreen && (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [isCalendarOpen && (jsxRuntime.jsx("div", { className: "data-picker-modal-overlay", onClick: handleCloseModal })), jsxRuntime.jsx("div", { className: `data-picker-modal ${isCalendarOpen ? "open" : ""}`, children: jsxRuntime.jsx("div", { className: "data-picker-modal-content", children: jsxRuntime.jsx(DatePickerCalendar, { selectedDate: selectedDate, onSelectDate: handleSelectDate, onClose: handleCloseModal, onRevert: handleRevert }) }) })] }))] }));
}
