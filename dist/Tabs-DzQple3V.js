...
function useTabs({ count }) {
    ...
    const tabItemGroupRef = useRef(null);
...
function TabContent({ content }) {
    return (jsx("div", { className: "tab-root", children: jsx("div", { children: content }) }));
}
...
const Tabs = ({ tabs, widthFull = false }) => {
    ...
    const tabButtonStyle = widthFull
        ...
        : undefined;
    return (jsxs("div", { className: "tab-root", children: [jsxs("div", { className: "tab-item-group", ref: tabItemGroupRef, children: [tabs.map((tab, index) => (jsx("button", { style: tabButtonStyle, className: `tab-item ${index === activeTab ? "tab-item-active" : ""}`, onClick: () => setActiveTab(index), role: "tab", "aria-selected": index === activeTab, children: tab.label }, index))), jsx("div", { className: "tab-indicator", style: {
                            left: indicatorStyle.left,
                            width: indicatorStyle.width,
                        } })] }), jsx("div", { className: "tab-content", role: "tabpanel", children: tabs[activeTab] && jsx(TabContent, { content: tabs[activeTab].content }) })] }));
};
