...
var DataPickerCalendar = function (_a) {
  ...
  var today = new Date();
  var _b = useState(new Date(date)),
    selectedDate = _b[0],
    setSelectedDate = _b[1];
  var _c = useState(date),
    inputDate = _c[0],
    setInputDate = _c[1];
  var _d = useState(new Date().getMonth()),
    currentMonth = _d[0],
    setCurrentMonth = _d[1];
  var _e = useState(new Date().getFullYear()),
    currentYear = _e[0],
    setCurrentYear = _e[1];
  ...
  var _h = useState(new Date().getMonth() + 1),
    selectedMonth = _h[0],
    setSelectedMonth = _h[1];
  var _j = useState(new Date().getFullYear()),
    selectedYear = _j[0],
    setSelectedYear = _j[1];
  var _k = useState(today.getDate()),
    selectedDay = _k[0],
    setSelectedDay = _k[1];
  useEffect(
    function () {
...
var ImageUploader = function (_a) {
  var proportion = _a.proportion,
    ...
    onChange = _a.onChange,
    value = _a.value;
  var _b = useState(value !== undefined ? value : null),
    selectedFiles = _b[0],
    setSelectedFiles = _b[1];
  var _c = useState([]),
    imagePreviews = _c[0],
...
var InputRadioButton = function (_a) {
  ...
  var _b = useState(controlledChecked || false),
    isChecked = _b[0],
    setIsChecked = _b[1];
  useEffect(
    function () {
