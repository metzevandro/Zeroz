...
var InputSearch = function (props) {
    ...
    var _b = useState(false); _b[0]; var setIsActive = _b[1];
    var inputRef = useRef(null);
...
var InputCheckbox = function (_a) {
    ...
    var _b = useState(modelValue !== null && modelValue !== void 0 ? modelValue : false), checked = _b[0], setChecked = _b[1];
    var uid = useMemo(function () { return id !== null && id !== void 0 ? id : "ui-form-checkbox-".concat(Math.random().toString(36).substr(2, 9)); }, [id]);
    useEffect(function () {
        if (modelValue !== checked) {
            setChecked(modelValue);
        }
    }, [modelValue]);
    var classList = useMemo(function () { return [disabled ? "-disabled" : "", noEvents ? "-no-events" : ""].join(" "); }, [disabled, noEvents]);
...
var InputSelect = function (_a) {
    ...
    var _b = useState(false), isOpen = _b[0], setIsOpen = _b[1];
    var _c = useState(value || undefined), selectedOption = _c[0], setSelectedOption = _c[1]; // Defina o valor inicial com a propriedade value
    useEffect(function () {
...
var SavebarTrigger = function (_a) {
    ...
    var _c = useState(null), tamanhoPai = _c[0], setTamanhoPai = _c[1];
    var _d = useState(false), saving = _d[0], setSaving = _d[1];
    var _e = useState(0), progressValue = _e[0], setProgressValue = _e[1]; // Progresso inicial é 0%
    var _f = useState(null); _f[0]; var setElapsedTime = _f[1];
    useEffect(function () {
        var updateTamanhoPai = function () {
...
var Slider = function (_a) {
    ...
    var _b = useState(((parseInt(value) - min) / (max - min)) * 100), progress = _b[0], setProgress = _b[1];
...
var Switch = function (_a) {
    ...
    var _b = useState(modelValue !== null && modelValue !== void 0 ? modelValue : false), checked = _b[0], setChecked = _b[1];
    var uid = useMemo(function () { return id !== null && id !== void 0 ? id : "ui-form-switch-".concat(Math.random().toString(36).substr(2, 9)); }, [id]);
    useEffect(function () {
        if (modelValue !== checked) {
            setChecked(modelValue);
        }
