 ...
 * </CardImage>
 */
const CardImage = ({ children, ...rest }) => (jsx("div", { className: "card-image", ...rest, children: children }));
 ...
 */
const CardHeader = ({ children, ...rest }) => (jsx("div", { className: "card-header", ...rest, children: children }));
 ...
 * </CardContent>
 */
const CardContent = ({ children, ...rest }) => (jsx("div", { className: "card-content", ...rest, children: children }));
 ...
 * </CardFooter>
 */
const CardFooter = ({ children, ...rest }) => (jsx("div", { className: "card-footer", ...rest, children: children }));
 ...
 * </Card>
 */
const Card = ({ children, ...rest }) => (jsx("div", { className: "card-root", ...rest, children: children }));
...
export { Card as C, CardImage as a, CardHeader as b, CardContent as c, CardFooter as d };
