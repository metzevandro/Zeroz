...
function DatePicker({ value, onChange, label, disabled = false, skeleton = false, }) {
    ...
    return (jsxs("div", { style: { display: "flex", flexDirection: "column" }, children: [jsx(Input, { label: label, onClick: () => setIsCalendarOpen((prev) => !prev), error: error, textError: errorMessage, value: inputValue, onChange: handleInputChange, onKeyDown: handleKeyDown, icon: "calendar_month", fillIcon: true, disabled: disabled, skeleton: skeleton }), jsx("div", { className: `data-picker ${isCalendarOpen ? "open" : ""}`, children: jsx(DatePickerCalendar, { selectedDate: selectedDate, onSelectDate: handleSelectDate, onClose: () => setIsCalendarOpen(false), onRevert: handleRevert }) })] }));
}
