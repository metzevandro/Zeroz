...
const ProgressIndicator = ({ step, description, state, direction, onClick, widthFull = false, }) => {
    ...
    return (jsxRuntime.jsxs("div", { className: `progress-indicator ${direction} ${state}`, onClick: onClick, style: getWidthStyle(widthFull), children: [jsxRuntime.jsxs("div", { className: `header ${state}`, children: [jsxRuntime.jsx("div", { children: jsxRuntime.jsx(Icon.Icon, { icon: icon, size: "sm", fill: !["circle", "block", "error"].includes(icon) }) }), jsxRuntime.jsx("h1", { children: step })] }), description && jsxRuntime.jsx("p", { children: description })] }));
};
