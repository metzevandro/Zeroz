...
import { S as Savebar } from './Savebar-jjGzvADE.js';
import { P as Progress } from './Progress-C6p1sVTR.js';
...
function useFormTracker({ initialValues, }) {
    ...
    const injectControlledProps = useCallback((child) => {
...
const SavebarTrigger = ({ children, initialValues, onSubmit, onCancel, label = "You have unsaved changes", labelSave = "Save", labelCancel = "Cancel", }) => {
    ...
    return (jsxs("div", { className: "form-register-root", children: [saving && (jsx("div", { className: "form-register-progress", children: jsx(Progress, { value: progressValue }) })), jsx("div", { className: "form-register-save-bar", style: saveBarStyle, children: formChanged && !saving && (jsx(Savebar, { label: label, labelSave: labelSave, labelCancel: labelCancel, onClickSave: handleSave, onClickCancel: handleCancel })) }), jsx("div", { children: modifiedChildren })] }));
};
SavebarTrigger.displayName = "SavebarTrigger";

export { SavebarTrigger as S };
