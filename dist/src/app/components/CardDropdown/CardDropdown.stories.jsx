...
export var Default = {
    render: function (args) {
        var _a, _b;
        return (<>
      <CardDropdown title={args.title} description={args.description} content={(_a = args.content) !== null && _a !== void 0 ? _a : (<div className="slot">
              <Icon icon="refresh" size="md"/>
              Slot Content
            </div>)} footer={(_b = args.footer) !== null && _b !== void 0 ? _b : (<div style={{ display: "flex", width: "min-content" }}>
