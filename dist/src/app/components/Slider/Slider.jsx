    ...
    return (<div className="slider">
      ...
      <div className="slider-container">
        ...
        <div style={{
          ...
          <div id="slider-background" className="slider-background" onMouseDown={function (e) { return handleSliderClick(e); }}>
            <div className="slider-progress-bar" style={{ width: "".concat(progress, "%") }}></div>
            <div className="slider-button" tabIndex={0} style={{ left: "calc(".concat(progress, "% - 10px)") }} onKeyDown={handleArrowKeyPress}></div>
          </div>
        </div>
