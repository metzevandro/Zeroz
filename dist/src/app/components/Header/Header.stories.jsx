...
var Template = function (args) {
    var _a = useState(false), isOpenHeader = _a[0], setIsOpenHeader = _a[1];
    var toggleHeader = function () {
        setIsOpenHeader(!isOpenHeader);
    };
    return (<div style={{ height: "300px" }}>
      <Header skeleton={args.skeleton} breadcrumb={<Breadcrumb items={[{ pageName: "Home", href: "/" }]}/>} onClick={toggleHeader}>
