    ...
    return (<div className="save-bar">
      <div className="save-bar-content">
        ...
        <div className="save-bar-buttons">
          <ButtonGroup variantFirstButton="secondary" variantSecondButton="success" direction="row" contentFirstButton={labelCancel} contentSecondButton={labelSave} onClickFirstButton={onClickCancel} onClickSecondButton={handleSaveClick}/>
        </div>
      </div>
    </div>);
};
