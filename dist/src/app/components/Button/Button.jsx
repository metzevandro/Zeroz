...
var Button = function (_a) {
    ...
    return (<>
      {skeleton && dimensions ? (<Skeleton height={"".concat(dimensions.height)} width={"".concat(dimensions.width)}/>) : (label && (<button {...rest} ref={buttonRef} className={buttonClass} disabled={disabled}>
