...
var SavebarTrigger = function (_a) {
    ...
    var _f = useState(null), elapsedTime = _f[0], setElapsedTime = _f[1];
    useEffect(function () {
    ...
    return (<div className="form-register-root">
      ...
      <div className="form-register-save-bar" style={estiloFilha}>
        {formChanged && !saving && (<SaveBar labelCancel={labelCancel} labelSave={labelSave} label={label} onClickCancel={handleCancel} onClickSave={handleSave}/>)}
      </div>
