  ...
  return (
    <div style={{ width: "320px" }}>
      <Card
        ...
        content={
          (_b = args.content) !== null && _b !== void 0 ? (
            _b
          ) : (
            <CardContent>
              <div className="slot">
  ...
  return (
    <div style={{ width: "320px" }}>
      <Card
        ...
        content={
          (_c = args.content) !== null && _c !== void 0 ? (
            _c
          ) : (
            <CardContent>
              <div className="slot">
