...
var EmptyState = function (_a) {
    ...
    return (<div className="empty-state-root">
      ...
      <div className="empty-state-footer">
        {buttonContentPrimary && (<Button size="md" variant="primary" label={buttonContentPrimary} onClick={onClickActionPrimary}/>)}
        {buttonContentSecondary && (<Button size="md" variant="secondary" label={buttonContentSecondary} onClick={onClickActionSecondary}/>)}
      </div>
    </div>);
};
// Exportação
