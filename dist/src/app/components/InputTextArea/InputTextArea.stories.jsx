      ...
      page: function () {
        return (
          <>
            ...
            <p>
              The <strong>Text Area</strong> input allows users to write and
              edit multiple lines of text, making it suitable for entering
              longer messages or detailed information
            </p>
            <Primary />
            <Controls />
            <Stories />
