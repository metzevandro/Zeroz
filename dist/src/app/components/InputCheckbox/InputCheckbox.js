...
var InputCheckbox = function (_a) {
    ...
    var uid = (0, react_1.useMemo)(function () { return id !== null && id !== void 0 ? id : "ui-form-checkbox-".concat(Math.random().toString(36).substr(2, 9)); }, [id]);
    (0, react_1.useEffect)(function () {
        if (modelValue !== checked) {
            setChecked(modelValue);
        }
    }, [modelValue]);
    var classList = (0, react_1.useMemo)(function () { return [disabled ? "-disabled" : "", noEvents ? "-no-events" : ""].join(" "); }, [disabled, noEvents]);
    ...
    return (react_1.default.createElement("label", { tabIndex: 0, className: "ui-form-checkbox ".concat(classList), htmlFor: uid, onKeyDown: handleKeyDown },
        react_1.default.createElement("input", { type: "checkbox", id: uid, value: value, required: required, ref: function (el) {
                if (el)
