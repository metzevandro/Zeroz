...
var ButtonIcon = function (_a) {
    ...
    return (<>
      {skeleton && dimensions ? (<Skeleton height={"".concat(dimensions.height)} width={"".concat(dimensions.width)}/>) : (<button {...rest} ref={buttonRef} disabled={disabled} className={"button-icon ".concat(variant, " ").concat(size, " ").concat(buttonType)}>
          {typeIcon && (<Icon icon={typeIcon} size={buttonType === "default" ? "md" : size}/>)}
        </button>)}
    </>);
};
