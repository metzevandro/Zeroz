...
var ButtonGroup = function (_a) {
    ...
    return (<>
      <div className={"button-group ".concat(direction)}>
        <Button size="md" disabled={disableFirstButton} onClick={onClickFirstButton} label={contentFirstButton} typeIcon={typeIconFirstButton} variant={variantFirstButton} skeleton={skeletonFirstButton}/>
        <Button size="md" disabled={disableSecondButton} onClick={onClickSecondButton} label={contentSecondButton} typeIcon={typeIconSecondButton} variant={variantSecondButton} skeleton={skeletonSecondButton}/>
      </div>
    </>);
};
