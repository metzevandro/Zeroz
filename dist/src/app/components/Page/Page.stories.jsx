      ...
      page: function () {
        return (
          <>
            ...
            <p>
              The <strong>Page</strong> template helps you create pages. It
              gives you all the things you need to make different layouts.
            </p>
            <Primary />
            <Controls />
            <Stories />
...
export var Default = {
  args: {
    ...
    onClickActionPrimary: function () {
      return alert("Primary button clicked");
    },
    onClickActionSecondary: function () {
