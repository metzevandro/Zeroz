...
const TextArea = forwardRef(({ label, placeholder, value = "", disabled = false, error = false, errorText = "", onChange, ...rest }, forwardedRef) => {
    ...
    return (jsxs("div", { className: "text-area-root", children: [jsx("label", { className: "text-area-label", children: label }), jsx("div", { role: "group", className: containerClass, onClick: handleContainerClick, onKeyDown: handleContainerKeyDown, children: jsx("textarea", { ref: resolvedRef, placeholder: placeholder, disabled: disabled, value: internalValue, onChange: handleChange, "aria-invalid": showError, "aria-describedby": showError ? "textarea-error" : undefined, ...rest }) }), showError && (jsx("p", { id: "textarea-error", className: "description", role: "alert", children: errorText }))] }));
});
