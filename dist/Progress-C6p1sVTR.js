...
const Progress = ({ value, error = false, indeterminate = false, }) => {
    ...
    return (jsx("div", { className: "progress", children: indeterminate ? (jsx("div", { className: "progress-bar-loading" })) : (jsx("div", { className: getProgressBarClass(clamped, error), style: { width: `${clamped}%` } })) }));
};
