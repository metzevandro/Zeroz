...
const Slider = ({ min, max, step, value, label, onChange, }) => {
    ...
    return (jsxs("div", { className: "slider", children: [label && (jsx("label", { id: labelId, className: "slider-label", htmlFor: uid, children: label })), jsxs("div", { className: "slider-container", children: [jsx("span", { className: "slider-max-min", children: min }), jsx("div", { className: "slider-track-wrapper", children: jsxs("div", { ref: trackRef, className: "slider-background", onMouseDown: handleTrackInteraction, children: [jsx("div", { className: "slider-progress-bar", style: { width: `${percent}%` } }), jsx("div", { className: "slider-button", role: "slider", tabIndex: 0, "aria-valuenow": value, "aria-valuemin": min, "aria-valuemax": max, "aria-labelledby": labelId, "aria-label": labelId ? undefined : "Slider", style: { left: `calc(${percent}% - 8px)` }, onKeyDown: handleKeyDown })] }) }), jsx("span", { className: "slider-max-min", children: max }), jsx("input", { id: uid, className: "slider-input", type: "number", inputMode: "numeric", min: min, max: max, step: step, value: value, onChange: handleInputChange })] })] }));
};
