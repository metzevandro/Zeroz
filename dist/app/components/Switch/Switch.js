...
var Switch = function Switch(_ref) {
  ...
  var uid = (0, _react.useMemo)(function () {
    return id !== null && id !== void 0 ? id : "ui-form-switch-".concat(Math.random().toString(36).substr(2, 9));
  }, [id]);
  ...
  var classList = (0, _react.useMemo)(function () {
    return ["ui-form-switch", "-switch", disabled ? "-disabled" : "", noEvents ? "-no-events" : ""].join(" ");
  }, [disabled, noEvents]);
