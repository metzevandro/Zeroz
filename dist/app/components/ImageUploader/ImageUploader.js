...
var ImageUploader = function ImageUploader(_ref) {
  var proportion = _ref.proportion,
    ...
    labelDropzone = _ref.labelDropzone,
    iconDropzone = _ref.iconDropzone,
    onChange = _ref.onChange,
    value = _ref.value;
  var _useState = (0, _react.useState)(value !== undefined ? value : null),
    _useState2 = _slicedToArray(_useState, 2),
    selectedFiles = _useState2[0],
    setSelectedFiles = _useState2[1];
  var _useState3 = (0, _react.useState)([]),
    _useState4 = _slicedToArray(_useState3, 2),
    imagePreviews = _useState4[0],
    setImagePreviews = _useState4[1];
  ...
  var _useState9 = (0, _react.useState)(false),
    ...
    fileRemoved = _useState10[0],
    setFileRemoved = _useState10[1];
  ...
  var handleFileChange = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(event) {
      var files, updatedFiles, promises, newFileList;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            updatedFiles = selectedFiles ? Array.from(selectedFiles) : [];
            _context2.prev = 5;
            promises = Array.from(files).map( /*#__PURE__*/function () {
          ...
          case 9:
            ...
            updatedFiles.forEach(function (file) {
              return newFileList.items.add(file);
            });
  ...
  var handleFile = /*#__PURE__*/function () {
            ...
            return _context3.abrupt("return", new Promise(function (resolve, reject) {
              ...
              reader.onloadend = function () {
                setImagePreviews(function (prevPreviews) {
                  return [].concat(_toConsumableArray(prevPreviews), [reader.result]);
                });
                resolve();
              };
    ...
    return function handleFile(_x3) {
  ...
  var handleRemoveFile = function handleRemoveFile(index) {
    ...
    setImagePreviews(function (prevPreviews) {
      var newPreviews = _toConsumableArray(prevPreviews);
  ...
  return <div className="image-uploader" onDragOver={handleDragOver} onDrop={handleDrop}>
      ...
      <div className="image-previews">
        {selectedFiles && imagePreviews && !isLoading && <>
          ...
          return <div key={index} className="image-uploader-item">
                <div className="delete-button-container">
                  <div className="delete-button">
                    <_ButtonIcon.default size="sm" buttonType="default" variant="secondary" typeIcon="delete" onClick={function () {
            ...
            }} src={imagePreviews && imagePreviews[index] ? imagePreviews[index] : ""} alt="Preview" className="image-preview" />
              </div>;
        })}
          </>}
        {(multiple || !selectedFiles || selectedFiles.length === 0) && <div className={"image-uploader-content ".concat(disabled ? "image-uploader-content-disabled" : "", " ").concat(!multiple && fileRemoved || multiple && (!selectedFiles || selectedFiles.length === 0) ? "" : "hidden")} style={{
        aspectRatio: "calc(".concat(proportion, ")")
      }}>
            <input type="file" accept="image/*" onChange={handleFileChange} ref={fileInputRef} disabled={disabled} style={{
          display: "none"
        }} multiple={multiple} />
            <div className={"".concat(isLoading ? "hidden" : "uploader-item")}>
              <button onClick={handleButtonClick} style={{
            aspectRatio: "calc(".concat(proportion, ")")
          }} className={"image-uploader-dropzone ".concat(disabled ? "image-uploader-dropzone-disabled" : "")}>
                <_Icon.default icon={iconDropzone} size="md" />
                <p>{labelDropzone}</p>
              </button>
            </div>
            {isLoading && <div className="loading-screen">
                <_Loading.default variant="default" />
              </div>}
          </div>}
      </div>
