...
const TextArea = React.forwardRef(({ label, placeholder, value = "", disabled = false, error = false, errorText = "", onChange, ...rest }, forwardedRef) => {
    ...
    return (jsxRuntime.jsxs("div", { className: "text-area-root", children: [jsxRuntime.jsx("label", { className: "text-area-label", children: label }), jsxRuntime.jsx("div", { role: "group", className: containerClass, onClick: handleContainerClick, onKeyDown: handleContainerKeyDown, children: jsxRuntime.jsx("textarea", { ref: resolvedRef, placeholder: placeholder, disabled: disabled, value: internalValue, onChange: handleChange, "aria-invalid": showError, "aria-describedby": showError ? "textarea-error" : undefined, ...rest }) }), showError && (jsxRuntime.jsx("p", { id: "textarea-error", className: "description", role: "alert", children: errorText }))] }));
});
