...
function DescriptionListItem({ title, description, direction, hasDivider, }) {
    return (jsxRuntime.jsxs("div", { className: `description-list-root ${direction}`, style: getDividerStyle(hasDivider), children: [jsxRuntime.jsx("div", { className: "title", children: title }), jsxRuntime.jsx("div", { className: "description", children: description })] }));
}
