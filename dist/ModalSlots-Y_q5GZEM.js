 ...
 * ```
 */
const Modal = ({ title, description, content, footer, hideModal, isOpen, dismissible = false, }) => (jsxs(Fragment, { children: [jsxs("div", { className: getModalClass("modal-root", isOpen), children: [jsx(ModalHeader, { title: title, description: description, dismissible: dismissible, onClose: hideModal }), content, footer] }), jsx("div", { className: getModalClass("modal-ghost", isOpen), onClick: dismissible ? hideModal : undefined })] }));
