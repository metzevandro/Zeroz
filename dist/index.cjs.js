...
var Avatar = function (_a) {
    ...
    return (React.createElement("div", { className: "avatar" }, skeleton ? (React.createElement(Skeleton, { height: "".concat(sizeInPixels), circle: true, width: "".concat(sizeInPixels) })) : (React.createElement(React.Fragment, null, src ? (React.createElement("label", { className: "avatar-image" },
        React.createElement("img", { className: size, src: src, alt: "Avatar" }))) : (React.createElement(React.Fragment, null, letter ? (React.createElement("label", { className: "avatar-letter ".concat(size) }, (_b = getLetter(letter)) === null || _b === void 0 ? void 0 : _b.toLocaleUpperCase())) : (React.createElement("label", { className: "avatar-icon ".concat(size) },
...
var DataPickerCalendar = function (_a) {
    ...
    var today = new Date();
    var _b = React.useState(new Date(date)), selectedDate = _b[0], setSelectedDate = _b[1];
    var _c = React.useState(date), inputDate = _c[0], setInputDate = _c[1];
    var _d = React.useState(new Date().getMonth()), currentMonth = _d[0], setCurrentMonth = _d[1];
    var _e = React.useState(new Date().getFullYear()), currentYear = _e[0], setCurrentYear = _e[1];
    var _f = React.useState(false), calendarOpen = _f[0], setCalendarOpen = _f[1];
    var _g = React.useState(false), secondModalOpen = _g[0], setSecondModalOpen = _g[1];
    var _h = React.useState(new Date().getMonth() + 1), selectedMonth = _h[0], setSelectedMonth = _h[1];
    var _j = React.useState(new Date().getFullYear()), selectedYear = _j[0], setSelectedYear = _j[1];
    var _k = React.useState(today.getDate()), selectedDay = _k[0], setSelectedDay = _k[1];
    React.useEffect(function () {
...
var Pagination = function (_a) {
    ...
    return (React.createElement("div", { className: "Pagination" }, variant === "noLabel" ? (React.createElement("div", { className: "noLabel" },
        React.createElement(PaginationItem, { arrow: "left", disabled: disabledLeft, click: onClickLeft }),
        React.createElement(PaginationItem, { arrow: "right", disabled: disabledRight, click: onClickRight }))) : variant === "leftLabel" ? (React.createElement("div", { className: "leftLabel" },
        React.createElement("p", null, label),
        React.createElement("div", { style: { display: "flex" } },
            React.createElement(PaginationItem, { arrow: "left", disabled: disabledLeft, click: onClickLeft }),
            React.createElement(PaginationItem, { arrow: "right", disabled: disabledRight, click: onClickRight })))) : variant === "centerLabel" ? (React.createElement("div", { className: "centerLabel" },
        React.createElement(PaginationItem, { arrow: "left", disabled: disabledLeft, click: onClickLeft }),
        React.createElement("p", null, label),
        React.createElement(PaginationItem, { arrow: "right", disabled: disabledRight, click: onClickRight }))) : ("error")));
};
...
var InputCheckbox = function (_a) {
    ...
    var _b = React.useState(modelValue !== null && modelValue !== void 0 ? modelValue : false), checked = _b[0], setChecked = _b[1];
    var uid = React.useMemo(function () { return id !== null && id !== void 0 ? id : "ui-form-checkbox-".concat(Math.random().toString(36).substr(2, 9)); }, [id]);
    React.useEffect(function () {
...
var DataTable = function (_a) {
    ...
    var _c = React.useState(originalData), filteredData = _c[0], setFilteredData = _c[1];
    var _d = React.useState(0), totalPages = _d[0], setTotalPages = _d[1];
    React.useEffect(function () {
    ...
    var _e = React.useState(originalData), originalDataState = _e[0], setOriginalDataState = _e[1];
    var _f = React.useState(false), selectAll = _f[0], setSelectAll = _f[1];
    var _g = React.useState([]), selectedRows = _g[0], setSelectedRows = _g[1];
    var _h = React.useState([]), expandedRows = _h[0], setExpandedRows = _h[1];
    var _j = React.useState(false), isAnyItemSelected = _j[0], setIsAnyItemSelected = _j[1];
    var _k = React.useState(""), searchTerm = _k[0], setSearchTerm = _k[1];
    var _l = React.useState(false), contentOverflowed = _l[0], setContentOverflowed = _l[1];
    var contentRef = React.useRef(null);
    var _m = React.useState(false), isOpenAside = _m[0], setIsOpenAside = _m[1];
    var _o = React.useState(columns.reduce(function (acc, column) {
        var _a;
        return (__assign(__assign({}, acc), (_a = {}, _a[column] = [], _a)));
    }, {})), filterOptions = _o[0], setFilterOptions = _o[1];
    var indexOfLastItem = currentPage * itemsPerPage;
    var indexOfFirstItem = indexOfLastItem - itemsPerPage;
    var _p = React.useState(false), allItemsExpanded = _p[0], setAllItemsExpanded = _p[1];
    React.useEffect(function () {
    ...
    var initialSortConfig = columns.length > 0
        ...
        : {};
    var _r = React.useState(initialSortConfig), sortConfig = _r[0], setSortConfig = _r[1];
...
var InputNumber = function (_a) {
    ...
    return (React.createElement("div", { className: "input-number-root" },
        ...
        React.createElement("div", { className: "input-number ".concat(disabled ? "disabled" : "") },
            ...
            React.createElement("input", { className: "input ".concat(error ? "error" : ""), type: "number", placeholder: placeholder, onChange: handleInputChange, value: numero !== undefined ? numero : "", max: max, min: min, disabled: disabled, inputMode: "numeric" }),
            React.createElement("button", { disabled: disabled, className: "add", onClick: addNum },
...
var Switch = function (_a) {
    ...
    var _b = React.useState(modelValue !== null && modelValue !== void 0 ? modelValue : false), checked = _b[0], setChecked = _b[1];
    var uid = React.useMemo(function () { return id !== null && id !== void 0 ? id : "ui-form-switch-".concat(Math.random().toString(36).substr(2, 9)); }, [id]);
    React.useEffect(function () {
        if (modelValue !== checked) {
            setChecked(modelValue);
        }
