...
const InputSearch = ({ placeholder, disabled = false, onChange, onDebouncedChange, debounceMs = 300, value, isSkeleton, ...rest }) => {
    ...
    if (isSkeleton && dimensions.width > 0) {
        return (jsxRuntime.jsx(Skeleton.Skeleton, { width: `${dimensions.width}px`, height: `${dimensions.height}px` }));
    }
    return (jsxRuntime.jsx("div", { ref: containerRef, className: `input-search-root ${disabled ? "disabled" : ""}`, onClick: handleFocus, children: jsxRuntime.jsxs("div", { className: "input-search", children: [jsxRuntime.jsx(Icon.Icon, { size: "md", icon: "search" }), jsxRuntime.jsx("input", { ...rest, ref: inputRef, type: "text", size: 1000, placeholder: placeholder, value: inputValue, disabled: disabled, onChange: handleChange, onBlur: handleBlur }), inputValue && (jsxRuntime.jsx("button", { className: "input-search-button-close visible", onClick: handleClear, children: jsxRuntime.jsx(ButtonIcon.ButtonIcon, { variant: "primary", icon: "close", appearance: "plain", size: "sm" }) }))] }) }));
};
