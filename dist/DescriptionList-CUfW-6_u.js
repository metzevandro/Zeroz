...
function DescriptionListItem({ title, description = "—", direction, hasDivider, }) {
    ...
    return (jsxRuntime.jsxs("div", { className: `description-list-root ${direction}`, style: getDividerStyle(hasDivider), children: [jsxRuntime.jsx("div", { className: "title", children: title }), jsxRuntime.jsx("div", { className: "description", children: displayValue })] }));
}
...
const DescriptionList = ({ items, direction, }) => {
    ...
    return (jsxRuntime.jsx(jsxRuntime.Fragment, { children: items.map((item, index) => (jsxRuntime.jsx(DescriptionListItem, { title: item.title, description: item.description, direction: direction, hasDivider: index < lastIndex }, `${item.title}-${index}`))) }));
};
