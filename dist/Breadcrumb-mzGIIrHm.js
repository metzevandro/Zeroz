 ...
 * />
 */
const Breadcrumb = ({ items }) => (jsxRuntime.jsx("nav", { "aria-label": "Breadcrumb", children: jsxRuntime.jsx("ol", { className: "breadcrumb", children: items.map((item, index) => (jsxRuntime.jsxs("li", { children: [isCurrentPage(index, items.length) ? (jsxRuntime.jsx(Link.Link, { "aria-current": "page", children: item.pageName })) : (jsxRuntime.jsx(Link.Link, { href: item.href, children: item.pageName })), shouldShowSeparator(index, items.length) && (jsxRuntime.jsx(Icon.Icon, { icon: "keyboard_arrow_right", size: "sm" }))] }, item.href))) }) }));
