declare module 'design-system-zeroz' {
...
export { default as InputRadioButton } from "./components/InputRadioButton/InputRadioButton";
...
export { default as InputTime } from "./components/InputTime/InputTime";
