    ...
    "./src/app/components/Notification/Notification.stories.tsx": (
      ...
      var jsx_runtime = __webpack_require__(
        ...
        Notification = __webpack_require__(
          "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[14].use[1]!./node_modules/postcss-loader/dist/cjs.js!./node_modules/resolve-url-loader/index.js!./node_modules/sass-loader/dist/cjs.js??ruleSet[1].rules[14].use[4]!./src/app/components/Notification/Notification.scss",
        ),
        options = {};
      (options.styleTagTransform = styleTagTransform_default()),
        (options.setAttributes = setAttributesWithoutAttributes_default()),
      ...
      const Notification_Notification_Notification = ({
          icon,
          title,
          description,
          variant,
          ...
          const [isClose, setIsClose] = (0, react.useState)(!0),
            showContent = withAction || description;
          return (0, jsx_runtime.jsx)(jsx_runtime.Fragment, {
            children:
              ...
              (0, jsx_runtime.jsxs)("div", {
                ...
                children: [
                  (0, jsx_runtime.jsxs)("div", {
                    className: `notification-title ${variant}`,
                    children: [
                      (0, jsx_runtime.jsx)(Icon.A, { icon, size: "md" }),
          ...
          (Notification_Notification_Notification.__docgenInfo = {
            ...
            props: {
              ...
              type: {
                ...
                type: {
                  name: "enum",
                  value: [{ value: '"float"' }, { value: '"inline"' }],
                },
              },
              isOpen: {
                defaultValue: null,
      ...
      const Notification_stories = {
          ...
          argTypes: {
            ...
            dismissible: {
              control: "boolean",
              description:
                "If true, the notification can be dismissed by the user.",
