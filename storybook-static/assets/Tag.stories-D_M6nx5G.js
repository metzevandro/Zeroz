import{r as l,j as e}from"./iframe-Cuzq1CpA.js";import{B as N}from"./ButtonIcon-g9GE-hSP.js";/* empty css               */import{B as P}from"./Button-BQCy7vfT.js";import"./preload-helper-PPVm8Dsz.js";import"./Icon-C2kFcyns.js";import"./Skeleton-BVkqHP_m.js";import"./Loading-CnlAraZ4.js";function W({animationDuration:t=200,onClose:a}){const[s,o]=l.useState(!1),[i,r]=l.useState(!1),d=l.useCallback(()=>{o(!0),setTimeout(()=>{r(!0),a?.()},t)},[t,a]);return{isDismissed:i,isClosing:s,handleClose:d}}const M=200;function n({content:t,variant:a,onClose:s}){const{isDismissed:o,isClosing:i,handleClose:r}=W({animationDuration:M,onClose:s});return o?null:e.jsxs("div",{className:["tag-root",a,i&&"tag-closing"].filter(Boolean).join(" "),children:[t,s&&e.jsx("span",{children:e.jsx(N,{appearance:"plain",size:"sm",icon:"close",variant:a==="secondary"?"primary":"on-color",onClick:r})})]})}var g,y,x,f,_,C,h,D,b,w,A,T,S,j,L,q,F,z,B,V,O,k,I,R,E;const X={title:"Components/Tag",component:n,tags:["autodocs"],parameters:{layout:"padded",design:{type:"figma",url:"https://www.figma.com/design/oxLCV1zqGHyB88OG91z86s/ZeroZ-Design-System?node-id=1320-552"},docs:{description:{component:`
