  ...
  [6596],
  {
    "./src/stories/ButtonIcon.stories.tsx": (
      ...
      var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
        ...
        _components_ButtonIcon_ButtonIcon__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__("./src/components/ButtonIcon/ButtonIcon.tsx"),
      ...
      const __WEBPACK_DEFAULT_EXPORT__ = {
          ...
          component:
            _components_ButtonIcon_ButtonIcon__WEBPACK_IMPORTED_MODULE_1__.A,
          parameters: {
            layout: "centered",
            docs: {
              page: () =>
          ...
          argTypes: {
            ...
            skeleton: {
              description:
                "Displays the button icon in a skeleton loading state.",
      ...
      (primary.parameters = {
        ...
        (OnColor.parameters = {
          ...OnColor.parameters,
          docs: {
            ...OnColor.parameters?.docs,
            source: {
              originalSource:
                '{\n  args: {\n    size: "md",\n    variant: "on-color",\n    buttonType: "plain",\n    typeIcon: "close",\n    skeleton: false,\n    disabled: false\n  }\n}',
              ...OnColor.parameters?.docs?.source,
            },
          },
        }),
        (Skeleton.parameters = {
