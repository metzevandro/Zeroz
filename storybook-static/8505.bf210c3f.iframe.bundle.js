  ...
  [8505],
  {
    ...
    "./src/app/components/DropdownMenu/DropdownMenu.tsx": (
      ...
      __webpack_require__.d(__webpack_exports__, {
        ...
        Ay: () => components_DropdownMenu_DropdownMenu,
      });
      var jsx_runtime = __webpack_require__(
          "./node_modules/next/dist/compiled/react/jsx-runtime.js",
        ),
      ...
      (options.styleTagTransform = styleTagTransform_default()),
        ...
        (options.domAPI = styleDomAPI_default()),
        (options.insertStyleElement = insertStyleElement_default());
      injectStylesIntoStyleTag_default()(DropdownMenu.A, options);
      DropdownMenu.A && DropdownMenu.A.locals && DropdownMenu.A.locals;
      __webpack_require__("./node_modules/next/dist/compiled/react/index.js");
      const DropDownMenu = (param) => {
        ...
        components_DropdownMenu_DropdownMenu = DropDownMenu;
    ...
    "./src/app/components/Header/Header.tsx": (
      ...
      const Header_Header_Header = (param) => {
        ...
        HeaderProfile = (param) => {
          let { name, children, avatar_src } = param;
      ...
      (module, __webpack_exports__, __webpack_require__) => {
        ...
        ___CSS_LOADER_EXPORT___.push([
          ...
          "",
          {
            ...
            names: [],
            mappings:
              "AAAA,oBACE,iBAAA,CAEA,mCACE,oCAAA,CACA,UAAA,CACA,iBAAA,CACA,UAAA,CACA,YAAA,CACA,kBAAA,CACA,qBAAA,CACA,0CAAA,CACA,4CAAA,CACA,yEAAA,CACA,6BAAA,CACA,kCAAA,CAEA,wDACE,yCAAA,CACA,uFAAA,CAEA,0CAAA,CACA,4CAAA,CACA,oCAAA,CACA,qBAAA,CACA,YAAA,CACA,UAAA,CAGF,uDACE,qBAAA,CACA,cAAA,CACA,UAAA,CACA,0CAAA,CACA,YAAA,CACA,kBAAA,CACA,6BAAA,CACA,iCAAA,CACA,0CAAA,CACA,4CAAA,CACA,oCAAA,CAEA,6DACE,kDAAA,CAGF,qEACE,0CAAA,CACA,SAAA,CACA,wCAAA,CACA,2CAAA,CACA,yCAAA,CACA,mBAAA",
            sourcesContent: [
      ...
      (module, __webpack_exports__, __webpack_require__) => {
        ...
        ___CSS_LOADER_EXPORT___.push([
          ...
          "",
          {
            ...
            names: [],
            mappings:
              "AAAA,eACE,YAAA,CACA,WAAA,CACA,cAAA,CACA,KAAA,CACA,MAAA,CAGF,aACE,4CAAA,CACA,eAAA,CACA,UAAA,CACA,KAAA,CACA,gBAAA,CACA,YAAA,CACA,kBAAA,CACA,qDAAA,CACA,6BAAA,CACA,gFAAA,CAEA,qBAAA,CACA,WAAA,CAEA,4BACE,YAAA,CAGF,sBACE,cAAA,CACA,YAAA,CACA,kBAAA,CACA,iCAAA,CACA,6BAAA,CACA,yCAAA,CACA,oCAAA,CACA,4CAAA,CACA,0CAAA,CACA,gBAAA,CAEA,4BACE,kDAAA,CAGF,oCACE,wCAAA,CACA,2CAAA,CACA,yCAAA,CACA,mBAAA,CAGF,8BACE,cAAA,CAGF,4BACE,YAAA,CACA,iCACE,yBAAA,CACA,uBAAA,CAEF,kCACE,uBAAA,CAIJ,4BACE,YAAA,CACA,yCAAA,CACA,oCAAA,CAKF,6BACE,YAAA,CAKN,qCACE,aACE,uDAAA,CACA,gCACE,YAAA,CAEF,4BACE,YAAA,CAGF,4BACE,WAAA,CAGF,2BACE,YAAA,CACA,qBAAA,CACA,eAAA,CAEA,oCACE,SAAA,CACA,uCAAA,CACA,0CACE,8BAAA,CAGF,0CACE,YAAA,CAGF,0CACE,YAAA,CAAA",
            sourcesContent: [
              ".profile-ghost {\n  height: 100vh;\n  width: 100vw;\n  position: fixed;\n  top: 0;\n  left: 0;\n}\n\n.header-root {\n  background-color: var(--s-color-fill-default);\n  position: sticky;\n  z-index: 97;\n  top: 0;\n  grid-area: header;\n  display: flex;\n  align-items: center;\n  padding: var(--s-spacing-nano) var(--s-spacing-medium);\n  justify-content: space-between;\n  border-bottom: var(--s-border-width-hairline) solid\n    var(--s-color-border-default);\n  box-sizing: border-box;\n  height: 64px;\n\n  .header-action {\n    display: none;\n  }\n\n  .profile {\n    cursor: pointer;\n    display: flex;\n    align-items: center;\n    padding: var(--s-spacing-xx-small);\n    gap: var(--s-spacing-xx-small);\n    font: var(--s-typography-paragraph-strong);\n    color: var(--s-color-content-default);\n    background-color: var(--s-color-fill-default);\n    border-radius: var(--s-border-radius-small);\n    user-select: none;\n\n    &:hover {\n      background-color: var(--s-color-fill-default-hover);\n    }\n\n    &:focus-visible {\n      outline-width: var(--s-border-width-thin);\n      outline-color: var(--s-color-fill-highlight);\n      outline-offset: var(--s-border-width-thin);\n      outline-style: solid;\n    }\n\n    .atavar {\n      cursor: pointer;\n    }\n\n    .icon {\n      display: flex;\n      &.open {\n        transform: rotate(-180deg);\n        transition: 0.3s ease-out;\n      }\n      &.close {\n        transition: 0.3s ease-out;\n      }\n    }\n\n    .name {\n      display: flex;\n      font: var(--s-typography-paragraph-strong);\n      color: var(--s-color-content-default);\n    }\n  }\n\n  .dropdown {\n    &.close {\n      display: none;\n    }\n  }\n}\n\n@media screen and (max-width: 768px) {\n  .header-root {\n    padding: var(--s-spacing-x-small) var(--s-spacing-small);\n    .header-breadcrumb {\n      display: none;\n    }\n    .header-action {\n      display: flex;\n    }\n\n    .dropdown.open {\n      width: 150px;\n    }\n\n    .profile-root {\n      display: flex;\n      flex-direction: column;\n      align-items: end;\n\n      .profile {\n        padding: 0;\n        border-radius: var(--border-radius-pill);\n        &:hover {\n          background-color: transparent;\n        }\n\n        .name {\n          display: none;\n        }\n\n        .icon {\n          display: none;\n        }\n      }\n    }\n  }\n}\n",
            ],
            sourceRoot: "",
          },
        ]);
