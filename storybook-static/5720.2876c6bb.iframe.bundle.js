    ...
    "./src/app/components/DataPicker/DataPicker.tsx": (
      ...
      var jsx_runtime = __webpack_require__(
        ...
        DataPicker = __webpack_require__(
          "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[14].use[1]!./node_modules/postcss-loader/dist/cjs.js!./node_modules/resolve-url-loader/index.js!./node_modules/sass-loader/dist/cjs.js??ruleSet[1].rules[14].use[4]!./src/app/components/DataPicker/DataPicker.scss",
        ),
        options = {};
      ...
      const DataPickerDay = ({ variant, day, onClick, onMouseEnter }) => {
          const formattedDay = day < 10 ? `0${day}` : `${day}`,
            buttonClass = `data-picker-day ${variant}`;
          ...
          const updateSelectedDateFormat = (month, year, day) => {
            ...
            generateMonthsAndYears = () => {
              ...
              for (let month = 1; month <= 12; month++)
                months.push({
                  month,
                  label: `${new Intl.DateTimeFormat("pt-BR", { month: "long" }).format(new Date(2e3, month - 1))}`,
                });
              for (
                    ...
                    children: [
                      (0, jsx_runtime.jsx)("div", {
                        ...
                        children: (0, jsx_runtime.jsxs)("div", {
                          ...
                          onClick: handleInputClick,
                          children: [
                            `${new Intl.DateTimeFormat("pt-BR", { month: "long" }).format(new Date(currentYear, currentMonth))} ${currentYear}`,
                            ...
                            children: (() => {
                              ...
                              for (
                                ...
                                days.push(
                                  (0, jsx_runtime.jsx)(
                                    DataPickerDay,
                                    { variant: "disable", day: date.getDate() },
                                    `previous-month-${i}`,
                                  ),
                                );
                              }
        ...
        DataPicker_DataPicker_DataPicker = ({
          label,
          placeholder,
          disabled,
          onDateChange,
    ...
    "./src/app/components/Input/Input.tsx": (
      ...
      var jsx_runtime = __webpack_require__(
        ...
        Input = __webpack_require__(
          "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[14].use[1]!./node_modules/postcss-loader/dist/cjs.js!./node_modules/resolve-url-loader/index.js!./node_modules/sass-loader/dist/cjs.js??ruleSet[1].rules[14].use[4]!./src/app/components/Input/Input.scss",
        ),
        options = {};
      (options.styleTagTransform = styleTagTransform_default()),
        (options.setAttributes = setAttributesWithoutAttributes_default()),
    ...
    "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[14].use[1]!./node_modules/postcss-loader/dist/cjs.js!./node_modules/resolve-url-loader/index.js!./node_modules/sass-loader/dist/cjs.js??ruleSet[1].rules[14].use[4]!./src/app/components/DataPicker/DataPicker.scss":
      (module, __webpack_exports__, __webpack_require__) => {
        ...
        ___CSS_LOADER_EXPORT___.push([
          module.id,
          ".data-picker-root{position:relative}.data-picker-root .data-picker-day{-webkit-box-sizing:border-box;-moz-box-sizing:border-box;user-select:none;align-items:center;justify-content:center;background-color:var(--s-color-fill-default);font:var(--s-typography-paragraph-regular);color:var(--s-color-content-default);border-radius:var(--s-border-radius-medium);cursor:pointer;width:100%;box-sizing:border-box;height:32px}.data-picker-root .data-picker-day.current-day{z-index:2;border:var(--s-border-width-thin) solid var(--s-color-border-highlight)}.data-picker-root .data-picker-day.current-day:hover{background-color:var(--s-color-fill-default-hover)}.data-picker-root .data-picker-day.default:hover{background-color:var(--s-color-fill-default-hover)}.data-picker-root .data-picker-day.default:focus-visible{z-index:3;color:var(--s-color-content-on-color);background-color:var(--s-color-fill-highlight);outline-width:var(--s-border-width-thin);outline-color:var(--s-color-fill-highlight);outline-offset:var(--s-border-width-thin);outline-style:solid}.data-picker-root .data-picker-day.active{background-color:var(--s-color-fill-highlight);color:var(--s-color-content-on-color)}.data-picker-root .data-picker-day.active:focus-visible{outline:none}.data-picker-root .data-picker-day.disable{color:var(--s-color-content-disable);cursor:default}.data-picker-root .data-picker{position:absolute;margin-top:var(--s-spacing-xx-small);width:288px;max-width:288px;padding:var(--s-spacing-small);background-color:var(--s-color-fill-default);border-radius:var(--s-border-radius-medium);box-shadow:var(--s-shadow-dropdown);flex-wrap:wrap;z-index:99;display:flex;flex-direction:column;gap:var(--s-spacing-small);border:var(--s-border-width-hairline) solid var(--s-color-border-default)}.data-picker-root .data-picker-month{font:var(--s-typography-paragraph-regular);color:var(--s-color-content-default);text-transform:capitalize;display:flex;justify-content:space-between}.data-picker-root .data-picker-week-days{text-align:center;display:grid;grid-template-columns:repeat(7, 1fr);font:var(--s-typography-caption-regular);color:var(--s-color-content-light)}.data-picker-root .data-picker-week-days p{text-align:center;padding:var(--s-spacing-xx-small) 14px;width:max-content;display:flex;align-items:center;justify-content:center}.data-picker-root .data-picker-days{text-align:center;display:grid;grid-template-columns:repeat(7, 1fr)}.data-picker-root .data-picker-label{display:flex;font:var(--s-typography-label-medium);color:var(--s-color-content-default)}.data-picker-root .data-picker-ghost{position:fixed;top:0;left:0;width:100vw;height:100vh}.data-picker-root .first-day-selected{background-color:var(--s-color-fill-highlight);border-radius:var(--s-border-radius-medium) 0 0 var(--s-border-radius-medium);color:var(--s-color-content-on-color)}.data-picker-root .first-day-selected:focus-visible{outline:none}.data-picker-root .last-day-selected{background-color:var(--s-color-fill-highlight);border-radius:0 var(--s-border-radius-medium) var(--s-border-radius-medium) 0;color:var(--s-color-content-on-color)}.data-picker-root .last-day-selected:focus-visible{outline:none}.data-picker-root .data-picker-value .input{color:var(--s-color-content-default)}.data-picker-root .data-picker-buttons-actions{width:100%;display:flex;justify-content:space-between}.data-picker-root .data-picker-buttons-actions *{width:min-content}.data-picker-root .data-picker-header{display:flex;align-items:center;cursor:pointer;user-select:none;padding:0 0 0 var(--s-spacing-xx-small);border-radius:var(--s-border-radius-medium)}.data-picker-root .data-picker-header:hover{background-color:var(--s-color-fill-default-hover)}.data-picker-root .data-picker-months-years{display:flex;gap:var(--s-spacing-xx-small)}.data-picker-root .data-picker-overflow-container{max-height:160px;overflow-y:auto;width:100%;scroll-behavior:smooth}.data-picker-root .data-picker-overflow-container::-webkit-scrollbar{width:0px}.data-picker-root .data-picker-overflow-content{width:100%;display:flex;align-items:center;flex-direction:column;font:var(--s-typography-paragraph-regular);color:var(--s-color-content-default);text-transform:capitalize}.data-picker-root .data-picker-overflow-content *{cursor:pointer}.data-picker-root .month-item{display:flex;justify-content:center;width:100%;cursor:pointer;transition:background-color .3s;border-radius:var(--s-border-radius-medium);padding:var(--s-spacing-nano) 0}.data-picker-root .month-item.selected{top:50%;background-color:var(--s-color-fill-highlight);color:#fff}.data-picker-root .month-item.selected:hover{background-color:var(--s-color-fill-highlight-hover)}.data-picker-root .month-item:hover{background-color:var(--s-color-fill-default-hover)}.data-picker-root .year-item{display:flex;justify-content:center;width:100%;cursor:pointer;transition:background-color .3s;border-radius:var(--s-border-radius-medium);padding:var(--s-spacing-nano) 0}.data-picker-root .year-item.selected{top:50%;background-color:var(--s-color-fill-highlight);color:#fff}.data-picker-root .year-item.selected:hover{background-color:var(--s-color-fill-highlight-hover)}.data-picker-root .year-item:hover{background-color:var(--s-color-fill-default-hover)}",
          "",
          {
            version: 3,
            sources: [
            ...
            names: [],
            mappings:
              "AAAA,kBACE,iBAAA,CAEA,mCACE,6BAAA,CACA,0BAAA,CACA,gBAAA,CACA,kBAAA,CACA,sBAAA,CACA,4CAAA,CACA,0CAAA,CACA,oCAAA,CACA,2CAAA,CACA,cAAA,CACA,UAAA,CACA,qBAAA,CACA,WAAA,CAGF,+CACE,SAAA,CACA,uEAAA,CAGF,qDACE,kDAAA,CAGF,iDACE,kDAAA,CAGF,yDACE,SAAA,CACA,qCAAA,CACA,8CAAA,CACA,wCAAA,CACA,2CAAA,CACA,yCAAA,CACA,mBAAA,CAGF,0CACE,8CAAA,CACA,qCAAA,CAGF,wDACE,YAAA,CAGF,2CACE,oCAAA,CACA,cAAA,CAGF,+BACE,iBAAA,CACA,oCAAA,CACA,WAAA,CACA,eAAA,CACA,8BAAA,CACA,4CAAA,CACA,2CAAA,CACA,mCAAA,CACA,cAAA,CACA,UAAA,CACA,YAAA,CACA,qBAAA,CACA,0BAAA,CACA,yEAAA,CAGF,qCACE,0CAAA,CACA,oCAAA,CACA,yBAAA,CACA,YAAA,CACA,6BAAA,CAGF,yCACE,iBAAA,CACA,YAAA,CACA,oCAAA,CACA,wCAAA,CACA,kCAAA,CAGF,2CACE,iBAAA,CACA,sCAAA,CACA,iBAAA,CACA,YAAA,CACA,kBAAA,CACA,sBAAA,CAGF,oCACE,iBAAA,CACA,YAAA,CACA,oCAAA,CAGF,qCACE,YAAA,CACA,qCAAA,CACA,oCAAA,CAGF,qCACE,cAAA,CACA,KAAA,CACA,MAAA,CACA,WAAA,CACA,YAAA,CAGF,sCACE,8CAAA,CACA,6EAAA,CAEA,qCAAA,CAGF,oDACE,YAAA,CAGF,qCACE,8CAAA,CACA,6EAAA,CAEA,qCAAA,CAGF,mDACE,YAAA,CAGF,4CACE,oCAAA,CAGF,+CACE,UAAA,CACA,YAAA,CACA,6BAAA,CACA,iDACE,iBAAA,CAIJ,sCACE,YAAA,CACA,kBAAA,CACA,cAAA,CACA,gBAAA,CACA,uCAAA,CACA,2CAAA,CAEA,4CACE,kDAAA,CAIJ,4CACE,YAAA,CACA,6BAAA,CAGF,kDACE,gBAAA,CACA,eAAA,CACA,UAAA,CACA,sBAAA,CAEA,qEACE,SAAA,CAIJ,gDACE,UAAA,CACA,YAAA,CACA,kBAAA,CACA,qBAAA,CACA,0CAAA,CACA,oCAAA,CACA,yBAAA,CACA,kDACE,cAAA,CAIJ,8BACE,YAAA,CACA,sBAAA,CACA,UAAA,CACA,cAAA,CACA,+BAAA,CACA,2CAAA,CACA,+BAAA,CAEA,uCACE,OAAA,CACA,8CAAA,CACA,UAAA,CAEA,6CACE,oDAAA,CAIJ,oCACE,kDAAA,CAIJ,6BACE,YAAA,CACA,sBAAA,CACA,UAAA,CACA,cAAA,CACA,+BAAA,CACA,2CAAA,CACA,+BAAA,CAEA,sCACE,OAAA,CACA,8CAAA,CACA,UAAA,CAEA,4CACE,oDAAA,CAIJ,mCACE,kDAAA",
            sourcesContent: [
              ".data-picker-root {\n  position: relative;\n\n  .data-picker-day {\n    -webkit-box-sizing: border-box;\n    -moz-box-sizing: border-box;\n    user-select: none;\n    align-items: center;\n    justify-content: center;\n    background-color: var(--s-color-fill-default);\n    font: var(--s-typography-paragraph-regular);\n    color: var(--s-color-content-default);\n    border-radius: var(--s-border-radius-medium);\n    cursor: pointer;\n    width: 100%;\n    box-sizing: border-box;\n    height: 32px;\n  }\n\n  .data-picker-day.current-day {\n    z-index: 2;\n    border: var(--s-border-width-thin) solid var(--s-color-border-highlight);\n  }\n\n  .data-picker-day.current-day:hover {\n    background-color: var(--s-color-fill-default-hover);\n  }\n\n  .data-picker-day.default:hover {\n    background-color: var(--s-color-fill-default-hover);\n  }\n\n  .data-picker-day.default:focus-visible {\n    z-index: 3;\n    color: var(--s-color-content-on-color);\n    background-color: var(--s-color-fill-highlight);\n    outline-width: var(--s-border-width-thin);\n    outline-color: var(--s-color-fill-highlight);\n    outline-offset: var(--s-border-width-thin);\n    outline-style: solid;\n  }\n\n  .data-picker-day.active {\n    background-color: var(--s-color-fill-highlight);\n    color: var(--s-color-content-on-color);\n  }\n\n  .data-picker-day.active:focus-visible {\n    outline: none;\n  }\n\n  .data-picker-day.disable {\n    color: var(--s-color-content-disable);\n    cursor: default;\n  }\n\n  .data-picker {\n    position: absolute;\n    margin-top: var(--s-spacing-xx-small);\n    width: 288px;\n    max-width: 288px;\n    padding: var(--s-spacing-small);\n    background-color: var(--s-color-fill-default);\n    border-radius: var(--s-border-radius-medium);\n    box-shadow: var(--s-shadow-dropdown);\n    flex-wrap: wrap;\n    z-index: 99;\n    display: flex;\n    flex-direction: column;\n    gap: var(--s-spacing-small);\n    border: var(--s-border-width-hairline) solid var(--s-color-border-default);\n  }\n\n  .data-picker-month {\n    font: var(--s-typography-paragraph-regular);\n    color: var(--s-color-content-default);\n    text-transform: capitalize;\n    display: flex;\n    justify-content: space-between;\n  }\n\n  .data-picker-week-days {\n    text-align: center;\n    display: grid;\n    grid-template-columns: repeat(7, 1fr);\n    font: var(--s-typography-caption-regular);\n    color: var(--s-color-content-light);\n  }\n\n  .data-picker-week-days p {\n    text-align: center;\n    padding: var(--s-spacing-xx-small) 14px;\n    width: max-content;\n    display: flex;\n    align-items: center;\n    justify-content: center;\n  }\n\n  .data-picker-days {\n    text-align: center;\n    display: grid;\n    grid-template-columns: repeat(7, 1fr);\n  }\n\n  .data-picker-label {\n    display: flex;\n    font: var(--s-typography-label-medium);\n    color: var(--s-color-content-default);\n  }\n\n  .data-picker-ghost {\n    position: fixed;\n    top: 0;\n    left: 0;\n    width: 100vw;\n    height: 100vh;\n  }\n\n  .first-day-selected {\n    background-color: var(--s-color-fill-highlight);\n    border-radius: var(--s-border-radius-medium) 0 0\n      var(--s-border-radius-medium);\n    color: var(--s-color-content-on-color);\n  }\n\n  .first-day-selected:focus-visible {\n    outline: none;\n  }\n\n  .last-day-selected {\n    background-color: var(--s-color-fill-highlight);\n    border-radius: 0 var(--s-border-radius-medium) var(--s-border-radius-medium)\n      0;\n    color: var(--s-color-content-on-color);\n  }\n\n  .last-day-selected:focus-visible {\n    outline: none;\n  }\n\n  .data-picker-value .input {\n    color: var(--s-color-content-default);\n  }\n\n  .data-picker-buttons-actions {\n    width: 100%;\n    display: flex;\n    justify-content: space-between;\n    * {\n      width: min-content;\n    }\n  }\n\n  .data-picker-header {\n    display: flex;\n    align-items: center;\n    cursor: pointer;\n    user-select: none;\n    padding: 0 0 0 var(--s-spacing-xx-small);\n    border-radius: var(--s-border-radius-medium);\n\n    &:hover {\n      background-color: var(--s-color-fill-default-hover);\n    }\n  }\n\n  .data-picker-months-years {\n    display: flex;\n    gap: var(--s-spacing-xx-small);\n  }\n\n  .data-picker-overflow-container {\n    max-height: 160px;\n    overflow-y: auto;\n    width: 100%;\n    scroll-behavior: smooth;\n\n    &::-webkit-scrollbar {\n      width: 0px;\n    }\n  }\n\n  .data-picker-overflow-content {\n    width: 100%;\n    display: flex;\n    align-items: center;\n    flex-direction: column;\n    font: var(--s-typography-paragraph-regular);\n    color: var(--s-color-content-default);\n    text-transform: capitalize;\n    * {\n      cursor: pointer;\n    }\n  }\n\n  .month-item {\n    display: flex;\n    justify-content: center;\n    width: 100%;\n    cursor: pointer;\n    transition: background-color 0.3s;\n    border-radius: var(--s-border-radius-medium);\n    padding: var(--s-spacing-nano) 0;\n\n    &.selected {\n      top: 50%;\n      background-color: var(--s-color-fill-highlight);\n      color: #fff;\n\n      &:hover {\n        background-color: var(--s-color-fill-highlight-hover);\n      }\n    }\n\n    &:hover {\n      background-color: var(--s-color-fill-default-hover);\n    }\n  }\n\n  .year-item {\n    display: flex;\n    justify-content: center;\n    width: 100%;\n    cursor: pointer;\n    transition: background-color 0.3s;\n    border-radius: var(--s-border-radius-medium);\n    padding: var(--s-spacing-nano) 0;\n\n    &.selected {\n      top: 50%;\n      background-color: var(--s-color-fill-highlight);\n      color: #fff;\n\n      &:hover {\n        background-color: var(--s-color-fill-highlight-hover);\n      }\n    }\n\n    &:hover {\n      background-color: var(--s-color-fill-default-hover);\n    }\n  }\n}\n",
            ],
            sourceRoot: "",
          },
        ]);
