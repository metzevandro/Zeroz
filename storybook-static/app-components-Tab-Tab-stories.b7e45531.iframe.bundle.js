  ...
  [697],
  {
    "./src/app/components/Tab/Tab.stories.tsx": (
      ...
      var jsx_runtime = __webpack_require__(
        ...
        Tab = __webpack_require__(
          "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[14].use[1]!./node_modules/postcss-loader/dist/cjs.js!./node_modules/resolve-url-loader/index.js!./node_modules/@storybook/nextjs/node_modules/sass-loader/dist/cjs.js??ruleSet[1].rules[14].use[4]!./src/app/components/Tab/Tab.scss",
        ),
        options = {};
      ...
      injectStylesIntoStyleTag_default()(Tab.A, options);
      Tab.A && Tab.A.locals && Tab.A.locals;
      const Tab_Tab_Tab = (param) => {
          let { content } = param;
          return (0, jsx_runtime.jsx)("div", {
            className: "tab-root",
            children: (0, jsx_runtime.jsx)("div", { children: content }),
          });
        },
        components_Tab_Tab = (param) => {
          let { tabs, widthFull } = param;
          const [activeTab, setActiveTab] = (0, react.useState)(0),
            tabItemGroupRef = (0, react.useRef)(null),
            customizeWidthFull = function () {
              if (
                arguments.length > 0 &&
                void 0 !== arguments[0] &&
                arguments[0]
          ...
          return (0, jsx_runtime.jsxs)("div", {
            ...
            children: [
                ...
                children: tabs.map((tab, index) =>
                  (0, jsx_runtime.jsx)(
                    "button",
                    {
                      ...
                      onClick: () =>
                        ((index) => {
                          if ((setActiveTab(index), tabItemGroupRef.current)) {
                            const tabItemWidth =
                                tabItemGroupRef.current.children[
                                  index
                                ].getBoundingClientRect().width,
                              scrollLeft = tabItemGroupRef.current.scrollLeft,
                              centerScroll =
                                tabItemGroupRef.current.children[
                                  index
                                ].getBoundingClientRect().left -
                                (tabItemGroupRef.current.clientWidth -
                                  tabItemWidth) /
                                  2;
              ...
              (0, jsx_runtime.jsx)("div", {
                ...
                children: (0, jsx_runtime.jsx)(Tab_Tab_Tab, {
      ...
      try {
        (Tab_Tab_Tab.displayName = "Tab"),
          (Tab_Tab_Tab.__docgenInfo = {
            description: "",
            displayName: "Tab",
            props: {
              label: {
          ...
          "undefined" != typeof STORYBOOK_REACT_CLASSES &&
            (STORYBOOK_REACT_CLASSES["src/app/components/Tab/Tab.tsx#Tab"] = {
              docgenInfo: Tab_Tab_Tab.__docgenInfo,
              name: "Tab",
              path: "src/app/components/Tab/Tab.tsx#Tab",
            });
      ...
      const Tab_stories = {
          ...
          component: components_Tab_Tab,
          argTypes: {},
          parameters: { tags: ["autodocs"] },
        },
        Template = (args) =>
          (0, jsx_runtime.jsx)(components_Tab_Tab, { ...args }),
        ...
        tabs: [
          {
            ...
            content: (0, jsx_runtime.jsxs)("div", {
              className: "slot",
              children: [
                (0, jsx_runtime.jsx)(Icon.A, { icon: "refresh", size: "md" }),
                "1st Content",
              ],
            }),
          },
      ...
      (WidthFull.args = {
        ...
        (Default.parameters = {
          ...
          docs: {
            ...
            source: {
              originalSource: "(args: TabsProps) => <Tabs {...args} />",
    ...
    "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[14].use[1]!./node_modules/postcss-loader/dist/cjs.js!./node_modules/resolve-url-loader/index.js!./node_modules/@storybook/nextjs/node_modules/sass-loader/dist/cjs.js??ruleSet[1].rules[14].use[4]!./src/app/components/Tab/Tab.scss":
      (module, __webpack_exports__, __webpack_require__) => {
        ...
        ___CSS_LOADER_EXPORT___.push([
          module.id,
          ".tab-root{width:100%}.tab-root .tab-item-group{display:flex;box-sizing:border-box;height:40px;padding:0 var(--s-spacing-xx-small);overflow-x:auto;scrollbar-width:none;-ms-overflow-style:none}.tab-root .tab-item-group::-webkit-scrollbar{display:none}.tab-root .tab-item-group .tab-item{height:40px;box-sizing:border-box;text-wrap:nowrap;font:var(--s-typography-label-medium);color:var(--s-color-content-light);padding:var(--s-spacing-xx-small) var(--s-spacing-small);background-color:rgba(0,0,0,0);cursor:pointer;border-bottom:var(--s-border-width-thin) var(--s-color-border-default) solid;border-radius:var(--s-border-radius-small) var(--s-border-radius-small) 0 0}.tab-root .tab-item-group .tab-item:hover{border-bottom:var(--s-border-width-thin) var(--s-color-border-highlight) solid;color:var(--s-color-content-default);background-color:var(--s-color-fill-default-hover)}.tab-root .tab-item-group .tab-item:focus-visible{outline-width:var(--s-border-width-thin);outline-color:var(--s-color-border-highlight);outline-offset:-2px;outline-style:solid}.tab-root .tab-item-group .tab-item-active{color:var(--s-color-content-highlight);padding:var(--s-spacing-xx-small) var(--s-spacing-small);border-bottom:var(--s-border-width-thin) var(--s-color-border-highlight) solid}.tab-root .tab-content{padding:var(--s-spacing-x-small)}@media screen and (max-width: 490px){.tab-item-active{color:var(--s-color-content-highlight);padding:var(--s-spacing-xx-small);border-bottom:var(--s-border-width-thin) var(--s-color-border-highlight) solid}.tab-item:hover{border-bottom:var(--s-border-width-thin) var(--s-color-border-highlight) solid;color:var(--s-color-content-default);padding:var(--s-spacing-xx-small)}}",
          "",
          {
            version: 3,
            sources: ["webpack://./src/app/components/Tab/Tab.scss"],
            names: [],
            mappings:
              "AAAA,UACE,UAAA,CAEA,0BACE,YAAA,CACA,qBAAA,CACA,WAAA,CACA,mCAAA,CACA,eAAA,CAMA,oBAAA,CACA,uBAAA,CALA,6CACE,YAAA,CAMF,oCACE,WAAA,CACA,qBAAA,CACA,gBAAA,CACA,qCAAA,CACA,kCAAA,CACA,wDAAA,CACA,8BAAA,CACA,cAAA,CACA,4EAAA,CAEA,2EAAA,CAIF,0CACE,8EAAA,CAEA,oCAAA,CACA,kDAAA,CAGF,kDACE,wCAAA,CACA,6CAAA,CACA,mBAAA,CACA,mBAAA,CAGF,2CACE,sCAAA,CACA,wDAAA,CACA,8EAAA,CAKJ,uBACE,gCAAA,CAIJ,qCACE,iBACE,sCAAA,CACA,iCAAA,CACA,8EAAA,CAGF,gBACE,8EAAA,CAEA,oCAAA,CACA,iCAAA,CAAA",
            sourcesContent: [
