    ...
    "./src/stories/Tab.stories.tsx": (
      ...
      var jsx_runtime = __webpack_require__(
        ...
        Tab = __webpack_require__(
          "./node_modules/@storybook/nextjs/node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[14].use[1]!./node_modules/postcss-loader/dist/cjs.js!./node_modules/resolve-url-loader/index.js!./node_modules/@storybook/nextjs/node_modules/sass-loader/dist/cjs.js??ruleSet[1].rules[14].use[4]!./src/components/Tab/Tab.scss",
        ),
        options = {};
                  ...
                  (0, jsx_runtime.jsx)(
                    "button",
                    {
                      ...
                      onClick: () => {
                        setActiveTab(index),
                          ((index) => {
                            if (!tabItemGroupRef.current) return;
                            const tabItems = tabItemGroupRef.current.children;
                            if (!tabItems || index >= tabItems.length) return;
                            const activeTabItem = tabItems[index];
                            if (!activeTabItem) return;
                            const activeTabItemWidth =
                                activeTabItem.getBoundingClientRect().width,
                              scrollLeft = tabItemGroupRef.current.scrollLeft,
                              centerScroll =
                                activeTabItem.getBoundingClientRect().left -
      ...
      try {
        (Tab_Tab_Tab.displayName = "Tab"),
          ...
          "undefined" != typeof STORYBOOK_REACT_CLASSES &&
            (STORYBOOK_REACT_CLASSES["src/components/Tab/Tab.tsx#Tab"] = {
              docgenInfo: Tab_Tab_Tab.__docgenInfo,
              name: "Tab",
              path: "src/components/Tab/Tab.tsx#Tab",
            });
      ...
      const Tab_stories = {
                ...
                (0, jsx_runtime.jsxs)(jsx_runtime.Fragment, {
                  children: [
                    ...
                    (0, jsx_runtime.jsxs)("p", {
                      children: [
                        "The ",
                        (0, jsx_runtime.jsx)("strong", { children: "Tabs " }),
          ...
          argTypes: {
            widthFull: {
              name: "Width Full",
              description:
                "Determines if the tabs should take up the full width.",
              type: { name: "boolean" },
    ...
    "./node_modules/@storybook/nextjs/node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[14].use[1]!./node_modules/postcss-loader/dist/cjs.js!./node_modules/resolve-url-loader/index.js!./node_modules/@storybook/nextjs/node_modules/sass-loader/dist/cjs.js??ruleSet[1].rules[14].use[4]!./src/components/Tab/Tab.scss":
      (module, __webpack_exports__, __webpack_require__) => {
        ...
        ___CSS_LOADER_EXPORT___.push([
          ...
          {
            version: 3,
            sources: ["webpack://./src/components/Tab/Tab.scss"],
            names: [],
            mappings:
