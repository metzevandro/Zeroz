    "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[14].use[1]!./node_modules/postcss-loader/dist/cjs.js!./node_modules/resolve-url-loader/index.js!./node_modules/@storybook/nextjs/node_modules/sass-loader/dist/cjs.js??ruleSet[1].rules[14].use[4]!./src/app/components/SaveBar/SaveBar.scss":
      (module, __webpack_exports__, __webpack_require__) => {
        ...
        ___CSS_LOADER_EXPORT___.push([
          module.id,
          ".save-bar{display:flex;justify-content:center;background-color:var(--s-color-fill-default);padding:var(--s-spacing-x-small) var(--s-spacing-x-large);box-shadow:var(--s-shadow-header);border-bottom:1px solid var(--s-color-border-default)}.save-bar .save-bar-content{width:100%;display:flex;flex-direction:row;align-items:center;justify-content:space-between;max-width:1280px}.save-bar .save-bar-content .save-bar-label{font:var(--s-typography-heading-small);color:var(--s-color-content-default)}.save-bar .save-bar-content .save-bar-buttons{display:flex}@media screen and (max-width: 768px){.save-bar{padding:var(--s-spacing-x-small) var(--s-spacing-small)}}",
          "",
          {
            version: 3,
            ...
            names: [],
            mappings:
              "AAAA,UACE,YAAA,CACA,sBAAA,CACA,4CAAA,CACA,yDAAA,CACA,iCAAA,CACA,qDAAA,CAEA,4BACE,UAAA,CACA,YAAA,CACA,kBAAA,CACA,kBAAA,CACA,6BAAA,CACA,gBAAA,CAEA,4CACE,sCAAA,CACA,oCAAA,CAGF,8CACE,YAAA,CAKN,qCACE,UACE,uDAAA,CAAA",
            sourcesContent: [
              ".save-bar {\n  display: flex;\n  justify-content: center;\n  background-color: var(--s-color-fill-default);\n  padding: var(--s-spacing-x-small) var(--s-spacing-x-large);\n  box-shadow: var(--s-shadow-header);\n  border-bottom: 1px solid var(--s-color-border-default);\n\n  .save-bar-content {\n    width: 100%;\n    display: flex;\n    flex-direction: row;\n    align-items: center;\n    justify-content: space-between;\n    max-width: 1280px;\n\n    .save-bar-label {\n      font: var(--s-typography-heading-small);\n      color: var(--s-color-content-default);\n    }\n\n    .save-bar-buttons {\n      display: flex;\n    }\n  }\n}\n\n@media screen and (max-width: 768px) {\n  .save-bar {\n    padding: var(--s-spacing-x-small) var(--s-spacing-small);\n  }\n}\n",
            ],
            sourceRoot: "",
          },
        ]);
    ...
    "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[14].use[1]!./node_modules/postcss-loader/dist/cjs.js!./node_modules/resolve-url-loader/index.js!./node_modules/@storybook/nextjs/node_modules/sass-loader/dist/cjs.js??ruleSet[1].rules[14].use[4]!./src/app/components/Switch/Switch.scss":
      (module, __webpack_exports__, __webpack_require__) => {
        ...
        ___CSS_LOADER_EXPORT___.push([
          module.id,
          ".switch-root{display:flex;align-items:center}.switch-root .switch{display:flex;justify-content:center;flex-direction:row;width:24px;height:24px;border-radius:var(--s-border-radius-small);color:var(--s-color-content-default);user-select:none;cursor:pointer}.switch-root .switch:hover{color:var(--s-color-content-highlight)}.switch-root .switch:focus-visible{outline-width:var(--s-border-width-thin);outline-color:var(--s-color-border-highlight);outline-style:solid}.switch-root .switch.checked{color:var(--s-color-content-highlight);background-color:rgba(0,0,0,0);transition:all .3s ease}.switch-root .switch.checked:hover{color:var(--s-color-content-highlight)}.switch-root .switch.unchecked{transition:all .3s ease}.switch-root .label{padding-left:var(--s-spacing-xx-small);font:var(--s-typography-paragraph-regular);color:var(--s-color-content-default);cursor:pointer;user-select:none}.switch-root .label.disabled{cursor:not-allowed}.switch-root .disabled{color:var(--s-color-content-disable);cursor:not-allowed}.switch-root .disabled .checked,.switch-root .disabled .unchecked,.switch-root .disabled:hover{color:var(--s-color-content-disable)}.switch-root .disabled:focus-visible{outline-width:none;outline-color:none;outline-style:none}.switch-root:hover .unchecked{color:var(--s-color-content-highlight)}",
          "",
          {
            version: 3,
            ...
            names: [],
            mappings:
              "AAAA,aACE,YAAA,CACA,kBAAA,CAEA,qBACE,YAAA,CACA,sBAAA,CACA,kBAAA,CACA,UAAA,CACA,WAAA,CACA,0CAAA,CACA,oCAAA,CACA,gBAAA,CACA,cAAA,CAEA,2BACE,sCAAA,CAGF,mCACE,wCAAA,CACA,6CAAA,CACA,mBAAA,CAGF,6BACE,sCAAA,CACA,8BAAA,CACA,uBAAA,CAEA,mCACE,sCAAA,CAGJ,+BACE,uBAAA,CAIJ,oBACE,sCAAA,CACA,0CAAA,CACA,oCAAA,CACA,cAAA,CACA,gBAAA,CAEA,6BACE,kBAAA,CAIJ,uBACE,oCAAA,CACA,kBAAA,CAEA,+FAGE,oCAAA,CAGF,qCACE,kBAAA,CACA,kBAAA,CACA,kBAAA,CAKN,8BACE,sCAAA",
            sourcesContent: [
              ".switch-root {\n  display: flex;\n  align-items: center;\n\n  .switch {\n    display: flex;\n    justify-content: center;\n    flex-direction: row;\n    width: 24px;\n    height: 24px;\n    border-radius: var(--s-border-radius-small);\n    color: var(--s-color-content-default);\n    user-select: none;\n    cursor: pointer;\n\n    &:hover {\n      color: var(--s-color-content-highlight);\n    }\n\n    &:focus-visible {\n      outline-width: var(--s-border-width-thin);\n      outline-color: var(--s-color-border-highlight);\n      outline-style: solid;\n    }\n\n    &.checked {\n      color: var(--s-color-content-highlight);\n      background-color: transparent;\n      transition: all 0.3s ease;\n\n      &:hover {\n        color: var(--s-color-content-highlight);\n      }\n    }\n    &.unchecked {\n      transition: all 0.3s ease;\n    }\n  }\n\n  .label {\n    padding-left: var(--s-spacing-xx-small);\n    font: var(--s-typography-paragraph-regular);\n    color: var(--s-color-content-default);\n    cursor: pointer;\n    user-select: none;\n\n    &.disabled {\n      cursor: not-allowed;\n    }\n  }\n\n  .disabled {\n    color: var(--s-color-content-disable);\n    cursor: not-allowed;\n\n    .checked,\n    .unchecked,\n    &:hover {\n      color: var(--s-color-content-disable);\n    }\n\n    &:focus-visible {\n      outline-width: none;\n      outline-color: none;\n      outline-style: none;\n    }\n  }\n}\n\n.switch-root:hover .unchecked {\n  color: var(--s-color-content-highlight);\n}\n",
            ],
            sourceRoot: "",
          },
        ]);
